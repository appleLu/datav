...
const getTabsBarStyles = stylesFactory((theme: DatavTheme, hideBorder = false) => {
...
export const TabsBar = React.forwardRef<HTMLDivElement, TabBarProps>(({ children, className, hideBorder }, ref) => {
